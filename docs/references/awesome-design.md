> **Origem:** copiado de [gztchan/awesome-design](https://github.com/gztchan/awesome-design)
> em 21/09/2026, licença **CC0** (domínio público — o autor renunciou aos direitos
> autorais sobre a obra). Não é documentação do Fortify: é uma lista de referência
> externa, mantida por Tony Chan e pela comunidade do repositório original. Para
> atualizações, consulte a fonte; este arquivo é um snapshot, não sincroniza sozinho.
...
- [LIBRESHOT](https://libreshot.com/) Free fine art and ordinary photography. Free images for blogs or websites even for commercial use. No need to mention the author.
