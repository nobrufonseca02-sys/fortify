...
function AuthBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 overflow-hidden bg-black" aria-hidden="true">
      <style>{`
        @media (prefers-reduced-motion: no-preference) {
          @keyframes fortify-accretion-spin {
            from { transform: translate(-50%, -50%) rotate(0deg) scaleX(1.85) scaleY(.46); }
            to { transform: translate(-50%, -50%) rotate(360deg) scaleX(1.85) scaleY(.46); }
          }
          @keyframes fortify-black-hole-breathe {
            0%, 100% { opacity: .78; filter: blur(22px); }
      ...
      `}</style>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(6,182,212,0.12),transparent_28%),radial-gradient(circle_at_42%_36%,rgba(109,40,217,0.18),transparent_34%),linear-gradient(180deg,#000_0%,#020617_58%,#000_100%)]" />
      ...
      <div className="absolute left-1/2 top-[43%] h-[760px] w-[760px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(14,165,233,0.16),rgba(88,28,135,0.12)_34%,transparent_66%)] blur-3xl motion-safe:animate-[fortify-black-hole-breathe_10s_ease-in-out_infinite]" />
      <div className="absolute left-1/2 top-[43%] h-[460px] w-[460px] rounded-full bg-[conic-gradient(from_20deg,transparent_0deg,rgba(56,189,248,0.05)_28deg,rgba(125,211,252,0.92)_66deg,rgba(168,85,247,0.7)_112deg,rgba(251,191,36,0.55)_168deg,transparent_210deg,rgba(59,130,246,0.75)_278deg,transparent_360deg)] blur-sm motion-safe:animate-[fortify-accretion-spin_28s_linear_infinite]" />
      <div className="absolute left-1/2 top-[43%] h-[360px] w-[520px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-200/20 bg-[radial-gradient(ellipse_at_center,transparent_34%,rgba(15,23,42,0.15)_40%,rgba(56,189,248,0.24)_47%,rgba(168,85,247,0.22)_58%,transparent_70%)] blur-[1px]" />
      <div className="absolute left-1/2 top-[43%] h-[240px] w-[240px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,#000_0%,#000_56%,rgba(15,23,42,0.9)_63%,transparent_74%)] shadow-[0_0_90px_34px_rgba(0,0,0,0.95),inset_0_0_80px_rgba(0,0,0,1)]" />
