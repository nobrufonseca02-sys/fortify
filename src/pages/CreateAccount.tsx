...
const FIRM_TEMPLATES: FirmTemplate[] = [
  {
  ...
  {
    id: 'myfundedfx', name: 'MyFundedFX', logo: 'MF', color: 'hsl(270, 70%, 55%)',
    description: 'Desafios acessíveis com regras simplificadas e payouts rápidos.',
    accountTypes: ['Challenge', 'Funded'],
    rules: [
      { type: 'MAX_DAILY_LOSS', name: 'Perda Diária Máxima', severity: 'hard', defaultValue: 5, unit: '%', editable: true, enabled: true },
      { type: 'MAX_TOTAL_LOSS', name: 'Perda Total Máxima', severity: 'hard', defaultValue: 12, unit: '%', editable: true, enabled: true },
      { type: 'PROFIT_TARGET', name: 'Meta de Lucro', severity: 'hard', defaultValue: 8, unit: '%', editable: true, enabled: true },
    ],
  },
  {
