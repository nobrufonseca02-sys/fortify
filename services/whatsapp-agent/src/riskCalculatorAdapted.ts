// Ported from src/lib/riskCalculator.ts -- keep in sync manually; no shared-package
// tooling exists in this repo yet (services/* are independent Node projects, no
// workspace/monorepo setup). Copied verbatim; do not diverge without a reason.
